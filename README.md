...
| משפחת מדידה | ערך |
|---|---:|
| **הורדות התוכנה** (שני המאגרים יחד) | **123,446** |
| ↳ מתוכן במאגר הקודם `Sivan22/otzaria` | 49,687 |
| ↳ מתוכן במאגר הנוכחי `Otzaria/otzaria` | 73,759 |
| הספרייה המלאה (קובץ הספרים) | 12,921 |
| עדכוני ספרייה (דלתא) | 14,528 |
| סך כל הקבצים שנמדדו (שלוש המשפחות יחד) | 150,895 |
| הורדות חדשות שנצפו מאז תחילת המעקב | 40,644 |

עדכון אחרון: `2026-09-20 04:59:39 UTC`. לתצוגה האינטראקטיבית המלאה יש להפעיל GitHub Pages.
<!-- stats:end -->
