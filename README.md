...
| משפחת מדידה | ערך |
|---|---:|
| **הורדות התוכנה** (שני המאגרים יחד) | **121,003** |
| ↳ מתוכן במאגר הקודם `Sivan22/otzaria` | 49,669 |
| ↳ מתוכן במאגר הנוכחי `Otzaria/otzaria` | 71,334 |
| הספרייה המלאה (קובץ הספרים) | 11,559 |
| עדכוני ספרייה (דלתא) | 12,134 |
| סך כל הקבצים שנמדדו (שלוש המשפחות יחד) | 144,696 |
