...
הלוח דו־לשוני — עברית (RTL) ואנגלית (LTR). השפה נבחרת אוטומטית לפי הגדרות הדפדפן, ניתנת לכפייה בקישור עם `?lang=he` / `?lang=en`, ונשמרת ב־localStorage דרך מתג השפה שבכותרת. כל המחרוזות יושבות במילון `site/i18n.js`.
...
| משפחת מדידה | ערך |
|---|---:|
| **הורדות התוכנה** (שני המאגרים יחד) | **123,978** |
| ↳ מתוכן במאגר הקודם `Sivan22/otzaria` | 49,695 |
| ↳ מתוכן במאגר הנוכחי `Otzaria/otzaria` | 74,283 |
| הספרייה המלאה (קובץ הספרים) | 13,274 |
| עדכוני ספרייה (דלתא) | 14,945 |
| סך כל הקבצים שנמדדו (שלוש המשפחות יחד) | 152,197 |
| הורדות חדשות שנצפו מאז תחילת המעקב | 41,946 |

עדכון אחרון: `2026-09-23 04:51:48 UTC`. לתצוגה האינטראקטיבית המלאה יש להפעיל GitHub Pages.
<!-- stats:end -->
