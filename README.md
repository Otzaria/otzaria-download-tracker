...
| מדד | ערך |
|---|---:|
| כלל ההורדות המצטברות המוצגות | **120,494** |
| גרסאות `Sivan22/otzaria` | 49,550 |
| גרסאות `Otzaria/otzaria` | 62,109 |
| הספרייה המלאה | 6,422 |
| עדכוני דלתא | 2,413 |
| הורדות חדשות שנצפו מאז תחילת המעקב | 10,202 |

עדכון אחרון: `2026-08-05 03:38:34 UTC`. לתצוגה האינטראקטיבית המלאה יש להפעיל GitHub Pages.
<!-- stats:end -->
