...
| מדד | ערך |
|---|---:|
| כלל ההורדות המצטברות המוצגות | **126,882** |
| גרסאות `Sivan22/otzaria` | 49,575 |
| גרסאות `Otzaria/otzaria` | 64,711 |
| הספרייה המלאה | 7,811 |
| עדכוני דלתא | 4,785 |
| הורדות חדשות שנצפו מאז תחילת המעקב | 16,596 |

עדכון אחרון: `2026-08-16 01:59:30 UTC`. לתצוגה האינטראקטיבית המלאה יש להפעיל GitHub Pages.
<!-- stats:end -->
