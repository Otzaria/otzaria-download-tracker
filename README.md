...
| משפחת מדידה | ערך |
|---|---:|
| **הורדות התוכנה** (שני המאגרים יחד) | **121,790** |
| ↳ מתוכן במאגר הקודם `Sivan22/otzaria` | 49,679 |
| ↳ מתוכן במאגר הנוכחי `Otzaria/otzaria` | 72,111 |
| הספרייה המלאה (קובץ הספרים) | 11,929 |
| עדכוני ספרייה (דלתא) | 13,231 |
| סך כל הקבצים שנמדדו (שלוש המשפחות יחד) | 146,950 |
| הורדות חדשות שנצפו מאז תחילת המעקב | 36,699 |

עדכון אחרון: `2026-09-15 05:00:54 UTC`. לתצוגה האינטראקטיבית המלאה יש להפעיל GitHub Pages.
<!-- stats:end -->
