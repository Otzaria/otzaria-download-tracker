...
| מדד | ערך |
|---|---:|
| כלל ההורדות המצטברות המוצגות | **110,460** |
| גרסאות `Sivan22/otzaria` | 49,485 |
| גרסאות `Otzaria/otzaria` | 57,560 |
| הספרייה המלאה | 3,368 |
| עדכוני דלתא | 47 |
| הורדות חדשות שנצפו מאז תחילת המעקב | 115 |

עדכון אחרון: `2026-07-20 06:31:04 UTC`. לתצוגה האינטראקטיבית המלאה יש להפעיל GitHub Pages.
<!-- stats:end -->
